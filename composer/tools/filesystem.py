...
class PutFileArgs(WithToolCallId):
    ...
    files: Dict[str, str] = Field(
        ...
        description="A dictionary associating RELATIVE pathnames to the contents to store at those path names. The provided contents "
            ...
            update={
                "messages": [
                    ToolMessage(
                        ...
                        content="No files provided to put_file; nothing written.",
                    )
                ]
            }
        )
